...
import com.example.mysubmission2.databinding.ItemUserBinding

class FollowersAdapter(private var listUser: ArrayList<DataUser>) : RecyclerView.Adapter<FollowersAdapter.ListViewHolder>() {
